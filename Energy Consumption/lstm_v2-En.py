...
model.add(LSTM(units=50, input_shape=(features.shape[1], features.shape[2]), activation='tanh', return_sequences=True))
...
with open("lstm2_en.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("lstm2_en.h5")
print("Saved model to disk")

#Load Model
from keras.models import model_from_json
json_file = open('lstm2_en.json', 'r')
