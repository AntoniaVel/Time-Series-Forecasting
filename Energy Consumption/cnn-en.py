...
model.add(Conv1D(filters=50, kernel_size=10, input_shape=(features.shape[1], features.shape[2]), activation='tanh'))
...
with open("cnn_en.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("cnn_en.h5")
print("Saved model to disk")

#Load Model
from keras.models import model_from_json
json_file = open('cnn_en.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("cnn_en.h5")
