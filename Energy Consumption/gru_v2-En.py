...
model.add(GRU(units=50, input_shape=(features.shape[1], features.shape[2]), activation='tanh', return_sequences=True))
...
with open("gru2_en.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("gru2_en.h5")
print("Saved model to disk")

#Load Model
from keras.models import model_from_json
json_file = open('gru2_en.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("gru2_en.h5")
